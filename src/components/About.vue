        ...
        <div class="container mx-auto">
          <div class="flex justify-between sm:flex-wrap sm:flex-col-reverse">
              ...
              <div class="sm:mb-[50px]">
                  <div class="relative">
                    <img class="relative z-10 sm:mx-auto" :src="profile.PROFILE_PICTURE" alt="">
                  ...
                  <div class="text-center mt-[30px]">
                    <h4 class="font-heebo text-[50px] lg:text-[80px] font-bold leading-[1] text-white title-stroke">5 Years</h4>
...
<script>
    import MenuMovil from "../../src/components/layout/MenuMovil.vue"
